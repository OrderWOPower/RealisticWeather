...
namespace RealisticWeather
{
    public static class RealisticWeatherHelper
    {
        ...
        public static float GetDustEffectOnShooterError(bool hasDust) => hasDust ? 1 + (MathF.Log(8, 2) * RealisticWeatherSettings.Instance.DustEffectOnShooterErrorMultiplier) : 1;
